	...
	<div class="login_background" style="width: 100%; height: 100%;">
		<div style="height: 200px"></div>
		    <div class="login"  >
				...
				<el-form-item>
					<el-button class="btnSubmit" type="success" plain round @click="onSubmit">ENTER</el-button>
				</el-form-item>
			</el-form> 
		    </div> 
	</div>
...
<style>
	...
	.login {
		...
		position: relative;
		border: 2px solid #8db6b7;
		border-radius: 15px;
		padding: 15px 50px;
		box-shadow: 0 0 25px #8ab3b7;
	}
